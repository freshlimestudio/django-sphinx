...
def _get_database_engine():
    if settings.DATABASE['default']['ENGINE'] == 'mysql':
        return settings.DATABASE['default']['ENGINE']
    elif settings.DATABASE['default']['ENGINE'].startswith('postgresql'):
        return 'pgsql'
...
DEFAULT_SPHINX_PARAMS = {
    ...
    'database_host': settings.DATABASE['default']['HOST'],
    'database_port': settings.DATABASE['default']['PORT'],
    'database_name': settings.DATABASE['default']['NAME'],
    'database_user': settings.DATABASE['default']['USER'],
    'database_password': settings.DATABASE['default']['PASSWORD'],
